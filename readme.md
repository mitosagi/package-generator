...
Google Colabとお好きな大規模言語モデル(LLM)を組み合わせて動きます。pythonインタプリタ付きの[ChatGPT Advanced Data Analysis](https://chat.openai.com/)がおすすめですが、無料で使える[GoogleのBard](https://bard.google.com/)でも動作します。
